...
public class ExampleController {
    ...
    public ExampleController() {
        this.messageService = NurigoApp.INSTANCE.initialize("NCSIVPAPXF7035LM", "VL4XX7BJRAOTXN09EHX8NR7ECZX0GLML", "https://api.coolsms.co.kr");
    }
    ...
    public SingleMessageSentResponse sendOne() {
        ...
        // 테스트 번호 - 금액 차감 안됨
        message.setTo("01095526908");
        message.setText("테스트 문자 발송 ☆★☆★☆★☆★");
